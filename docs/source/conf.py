...
# spaceflights_temp documentation build
...
from spaceflights_temp import __version__ as release

# -- Project information -----------------------------------------------------

project = "spaceflights_temp"
author = "Kedro"
...
htmlhelp_basename = "spaceflights_tempdoc"
...
latex_documents = [
    (
        master_doc,
        "spaceflights_temp.tex",
        "spaceflights_temp Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "spaceflights_temp",
        "Project spaceflights_temp codebase.",
        "Data-Science",
    )
]
